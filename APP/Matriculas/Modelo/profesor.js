...
import { StyleSheet, Text, View, Alert, TextInput, TouchableOpacity,
  ...
  export default class profesor extends React.Component
  {
    ...
    {
      super(ops)
      //Aquí definimos las variables para la tabla Profesor de la Base
      //MatriculasAPI
      //
      this.state = 
      {
        TextInputid_profesor:"",
        TextInputid_departamento:""
    ...
    InsertarProfesor = () =>
    {
      ...
      //https://localhost:44351/Api/profesor
...
ActualizarProfesor = () =>
{
  ...
  fetch(
    'https://localhost:44351/Api/profesor',
    {
        ...
        body: JSON.stringify(
        {
            id_profesor: this.state.TextInput_id,
            id_departamento: this.state.TextInput_id
        }
        )
  ...
  BorrarProfesor = () =>
  {
    //Invocamos el EndPoint desde la API para borrar profesor en la DB.
    fetch
    (
      'https://localhost:44351/Api/profesor',
      {
...
ListarTodasProfesor = () =>
{
    ...
    .then((responseJson) =>
    {
      this.state(
        {
      TextInput_id_profesor: responseJson[0]['id'],
      TextInput_id_departamento: responseJson[0]['departamento']
...
ListarProfesorxId = () =>
{
    ...
    .then((responseJson) =>
    {
      this.state(
      { 
        TextInputid_profesor: responseJson[0]['id'],
        TextInputid_departamento: responseJson[0]['departamento']
